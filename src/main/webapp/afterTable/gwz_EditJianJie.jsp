<%@ page import="com.dgut.group22.javaBean.Course" %>
    ...
    %>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" id="course_introduction" value="<%=course.getCourse_introduction()%>" name="course_introduction" class="layui-textarea" ></textarea>
            </div>
        </div>
