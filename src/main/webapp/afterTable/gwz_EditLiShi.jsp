...
<html class="x-admin-sm">
    ...
    <body>
    <%
        gwz_Course course=(gwz_Course) request.getSession().getAttribute("EditLiShi_course");
    %>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="/course/accept_EditLiShi">
        ...
        <div class="layui-form-item layui-form-text">
            <label for="course_history" class="layui-form-label">历史沿革</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" value="<%=course.getCourse_history()%>" id="course_history" name="course_history" class="layui-textarea"></textarea>
            </div>
        </div>
