...
public class successCourse {
    ...
    public successCourse(int success_id, int course_id, int teacher_id, Data time, String success_myself, String success_student, String success_society, String success_evaluation, String success_wechat, String success_QQ, String success_port) {
        this.success_id = success_id;
        this.course_id = course_id;
        this.teacher_id = teacher_id;
        this.time = time;
