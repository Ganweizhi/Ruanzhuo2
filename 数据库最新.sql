...
CREATE TABLE teaching_program(
       teaching_program_id int NOT NULL auto_increment primary key,
...
--
-- INSERT into team(team_id,team_name,course_id, photo_team) VALUES('1','team1','1',images/teacher_img2.jpg);
-- INSERT into team(team_id,team_name,course_id，photo_team) VALUES('2','team2','2',images/teacher_img2.jpg);
